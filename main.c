...
static App *hc11_modem_app_init() {
  ...
  app->item_channel = variable_item_list_add(app->config_list,
						config_channel_label,
						nb_config_channel_values,
						config_channel_change, app);

  /* Add address option list item */
  app->item_address = variable_item_list_add(app->config_list,
						config_address_label,
						nb_config_address_values,
						config_address_change, app);

  /* Add address option list item */
  app->item_txpower = variable_item_list_add(app->config_list,
						config_txpower_label,
						nb_config_txpower_values,
						config_txpower_change, app);
  ...
  app->item_passthru_chan = variable_item_list_add(app->config_list,
